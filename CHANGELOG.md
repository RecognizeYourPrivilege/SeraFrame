...
- The fullscreen image accepts a two-finger pinch (1× to 4×). A one-finger horizontal swipe still changes images at the fitted size. A pinch does not. Tapping the dimmed area still closes the overlay.
